...
namespace AGS.Editor
{
    public class AGSEditor : ISourceControlIntegration
    {
        ...
        */
        ...
        private Game _game;
        private AGSCompiler _agsCompiler;
        ...
        public AGSCompiler Compiler
        {
            get { return _agsCompiler; }
        }
        ...
        /// user cannot change
        /// </summary>
        public List<Script> GetInternalScriptHeaders()
        {
        ...
        /// user cannot change
        /// </summary>
        public List<Script> GetInternalScriptModules()
        {
            List<Script> scripts = new List<Script>();
